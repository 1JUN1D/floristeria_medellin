...
const products = [
    ...
    { id: 67, code: "067", category: "Rosas Amarillas", tags: ["rosas", "arreglos"], name: "Rayos de Amistad", description: "Bouquet delicado de rosas amarillas con gypsophila y mariposa dorada en empaque de corazones. Transmite amistad sincera y alegría luminosa en cada pétalo.", price: 100000, image: "assets/catalog/foto67.webp" },
    { id: 68, code: "068", category: "Rosas con Chocolates", tags: ["rosas", "girasoles", "arreglos", "chocolates"], name: "Pasión Solar Dulce", description: "Bouquet de rosas rojas con girasol central y chocolates Jumbo y Kinder en empaque rojo. Combina amor intenso con dulzura irresistible en un solo detalle.", price: 137500, image: "assets/catalog/foto68.webp" },
    { id: 69, code: "069", category: "Anchetas Snacks", tags: ["cumpleaños", "arreglos"], name: "Festejo Cervecero", description: "Ancheta de cumpleaños con cervezas Corona, M&Ms, dulces y globos Happy Birthday en caja de madera. Perfecta para celebrar el día especial de él.", price: 162500, image: "assets/catalog/foto69.webp" },
    { id: 70, code: "070", category: "Desayunos Sorpresa", tags: ["rosas", "girasoles", "cumpleaños", "arreglos"], name: "Mañana Soleada", description: "Bandeja desayuno con girasoles, rosas rojas, jugos, club social, arequipe y globos Feliz Cumpleaños. Sorprende con un amanecer cargado de cariño y sabor.", price: 206250, image: "assets/catalog/foto70.webp" },
    { id: 71, code: "071", category: "Arreglos Especiales", tags: ["rosas", "girasoles", "arreglos"], name: "Pirámide Imperial Frutal", description: "Arreglo grande con rosas rojas y coral, girasoles, lirios, ave del paraíso, uvas y manzanas. Diseño imponente para celebraciones que merecen impacto total.", price: 275000, image: "assets/catalog/foto71.webp" },
    { id: 72, code: "072", category: "Rosas y Girasoles", tags: ["rosas", "girasoles", "arreglos"], name: "Sol y Pasión Tierna", description: "Bouquet circular de girasoles, rosas rojas y aster blanca en empaque rosa. Combina la alegría del sol con la pasión del amor en presentación natural.", price: 100000, image: "assets/catalog/foto72.webp" },
    { id: 73, code: "073", category: "Rosas y Girasoles", tags: ["rosas", "girasoles", "arreglos"], name: "Mariposa Nocturna", description: "Bouquet vertical de rosas rosadas y girasoles con mariposas plateadas en empaque negro. Diseño elegante y único que combina ternura con sofisticación moderna.", price: 150000, image: "assets/catalog/foto73.webp" },
    { id: 74, code: "074", category: "Anchetas con Flores", tags: ["rosas", "girasoles", "cumpleaños", "arreglos", "chocolates"], name: "Torre Solar", description: "Arreglo vertical de girasoles altos con rosas rojas, chocolates y moño rosado. Diseño imponente que celebra cumpleaños con luz y elegancia natural.", price: 162500, image: "assets/catalog/foto74.webp" },
    { id: 75, code: "075", category: "Anchetas con Flores", tags: ["rosas", "girasoles", "arreglos"], name: "Brindis Blanco", description: "Arreglo en caja de madera con rosas blancas, girasoles y cervezas Corona. Perfecto para brindar por momentos especiales con elegancia pura.", price: 175000, image: "assets/catalog/foto75.webp" },
    { id: 76, code: "076", category: "Anchetas con Flores", tags: ["rosas", "arreglos", "chocolates"], name: "Cumbre Roja", description: "Arreglo vertical de rosas rojas con ave del paraíso, frutas y chocolates Especial. Diseño majestuoso que combina pasión, sabor y belleza natural.", price: 162500, image: "assets/catalog/foto76.webp" },
];
